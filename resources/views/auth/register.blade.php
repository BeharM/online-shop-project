...
<div class="flex min-h-full flex-col justify-center px-6 py-4 lg:px-8">
    <div class="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            Have An Account?
            <a href="{{Route('login.create')}}" class="mt-1 flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Sign In</a>
        </p>
    </div>
</div>
@endsection
