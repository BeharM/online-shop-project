                        ...
                        @foreach($orders as $key=> $order)
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <button type="button" data-id="{{$key}}" id="update-cart-id-{{$key}}"  data-tooltip-target="tooltip-refresh-default" class="update-cart-from ml-4 font-medium text-green-600 dark:text-green-500 hover:underline">
